...
function LandingPage({ onGetStarted }) {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#FDF6F0]">
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-10">
          <span className="bg-white/80 shadow-sm text-gray-700 px-4 py-1.5 rounded-full text-sm font-medium border border-gray-200/60">
            🤖 AI Translation
          </span>
          <span className="bg-white/80 shadow-sm text-gray-700 px-4 py-1.5 rounded-full text-sm font-medium border border-gray-200/60">
            📋 Instant Copy
